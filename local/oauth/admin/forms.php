...
//        $mform->setType('request_token_url', PARAM_URL);
        $mform->addHelpButton('request_token_url', 'siterequest', 'local_oauth');
...
//        $mform->setType('authorize_token_url', PARAM_URL);
        $mform->addHelpButton('authorize_token_url', 'siteauthorize', 'local_oauth');
...
//        $mform->setType('access_token_url', PARAM_URL);
        $mform->addHelpButton('access_token_url', 'siteaccess', 'local_oauth');
