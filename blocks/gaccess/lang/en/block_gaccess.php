...
$string['start'] = 'Show Google+ Link';
$string['start_desc'] = 'If selected Google+ link will be shown.';
$string['calendar'] = 'Show Google Calendar Link';
$string['calendar_desc'] = 'If selected Google Calendar link will be shown.';
$string['classroom'] = 'Show Google Classroom Link';
$string['classroom_desc'] = 'If selected Google Classroom link will be shown.';
